            ...
            <nav class="flex-1 space-y-0.5 overflow-y-auto px-3 py-4">
                ...
                <div>
                    ...
                    <div class="ml-3 mt-0.5 border-l border-slate-700 pl-4 space-y-0.5">
                        ...
                        <a href="{{ route('customers.deactivated') }}" class="flex items-center gap-2 rounded-lg bg-cyan-600/20 px-3 py-2 text-sm font-medium text-cyan-300">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" class="h-3.5 w-3.5 shrink-0" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M18.364 18.364A9 9 0 0 0 5.636 5.636m12.728 12.728A9 9 0 0 1 5.636 5.636m12.728 12.728L5.636 5.636" />
                            </svg>
                            Nonaktif
                            @if ($customers->count() > 0)
                                <span class="ml-auto rounded-full bg-cyan-900 px-1.5 py-0.5 text-xs text-cyan-100">{{ $customers->count() }}</span>
                            @endif
                        </a>
                    </div>
                </div>
